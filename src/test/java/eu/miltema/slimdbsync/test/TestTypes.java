...
public class TestTypes extends AbstractDatabaseTest {
	...
	public void setup() throws Exception {
		db.deleteWhere(SyncTypesEntity.class, "f_short1<>?", 8);
	}

	private SyncTypesEntity fetch() throws Exception {
		return db.listAll(SyncTypesEntity.class).get(0);
	}

	@Test
	public void testString() throws Exception {
		db.insert(new SyncTypesEntity(x -> x.fString = "abc"));
		assertEquals("abc", fetch().fString);
	}

	@Test
	public void testByte() throws Exception {
		db.insert(new SyncTypesEntity(x -> x.fByte1 = (byte) 0xF3, x -> x.fByte2 = 34));
		SyncTypesEntity e = fetch();
	...
	public void testShort() throws Exception {
		db.insert(new SyncTypesEntity(x -> x.fShort1 = -23, x -> x.fShort2 = 34));
		SyncTypesEntity e = fetch();
	...
	public void testInt() throws Exception {
		db.insert(new SyncTypesEntity(x -> x.fInt1 = 23, x -> x.fInt2 = -34));
		SyncTypesEntity e = fetch();
	...
	public void testLong() throws Exception {
		db.insert(new SyncTypesEntity(x -> x.fLong1 = -23L, x -> x.fLong2 = 34L));
		SyncTypesEntity e = fetch();
	...
	public void testFloat() throws Exception {
		db.insert(new SyncTypesEntity(x -> x.fFloat1 = 23.78f, x -> x.fFloat2 = 34.11f));
		SyncTypesEntity e = fetch();
	...
	public void testDouble() throws Exception {
		db.insert(new SyncTypesEntity(x -> x.fDouble1 = 23.28d, x -> x.fDouble2 = 34.11d));
		SyncTypesEntity e = fetch();
	...
	public void testBigDecimal() throws Exception {
		...
		db.insert(new SyncTypesEntity(x -> x.fBigDecimal = b));
	...
	public void testByteArray() throws Exception {
		byte[] ba = {4, 7, 9, -5};
		db.insert(new SyncTypesEntity(x -> x.fByteArray = ba));
	...
	public void testTimestampWithoutTimezone() throws Exception {
		...
		db.insert(new SyncTypesEntity(x -> x.fTimestamp = ts));
	...
	public void testInstant() throws Exception {
		Instant i = Instant.parse("2007-12-03T10:15:30.00Z");
		db.insert(new SyncTypesEntity(x -> x.fInstant = i));
	...
	public void testZonedDateTime() throws Exception {
		...
		db.insert(new SyncTypesEntity(x -> x.fZonedDateTime = zdt));
	...
	public void testLocalDate() throws Exception {
		...
		db.insert(new SyncTypesEntity(x -> x.fLocalDate = ld));
	...
	public void testLocalDateTime() throws Exception {
		...
		db.insert(new SyncTypesEntity(x -> x.fLocalDateTime = ldt));
		assertEquals(ldt, fetch().fLocalDateTime);
	}

	@Test
	public void testJSon() throws Exception {
		db.insert(new SyncTypesEntity(x -> x.fJson = new String[] {"abc", "def"}));
