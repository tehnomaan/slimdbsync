...
DROP TABLE IF EXISTS public.entity2 CASCADE;
DROP TABLE IF EXISTS public.entity3 CASCADE;
DROP TABLE IF EXISTS public.entity4 CASCADE;
DROP TABLE IF EXISTS public.entity5 CASCADE;
...
DROP SEQUENCE IF EXISTS public.entity6_id_seq;
